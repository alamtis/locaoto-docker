...
<template>
    ...
    <div class="rounded-lg">
        ...
        <Dialog v-model:visible="addModal" :modal="true" class="md:min-w-52">
            <template #header>
            ...
            <form class="mt-2">
                <div class="md:mt-6 md:flex md:justify-between">
                    <Dropdown
                        ...
                        :filter="true"
                        :options="carBrands"
                        class="mb-2 w-full md:mr-5 md:flex-1"
                        optionLabel="name"
                        optionValue="id"
                ...
                <div class="md:mt-6 md:flex md:justify-between">
                    <span class="p-float-label mb-2 md:mr-4 md:flex-1">
                        <InputNumber
                ...
                <div class="md:mt-6 md:flex md:justify-between">
                    <div class="mb-2 border pl-5 md:flex-1">
