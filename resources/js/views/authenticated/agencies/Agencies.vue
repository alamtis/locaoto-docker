    ...
    <Authenticated>
        ...
        >
            ...
            <form class="mt-2" @submit.prevent="storeAgency">
                ...
                <div class="mt-6">
                    <img v-show="imageUrl" :src="imageUrl" accept="image/*" class="w-48 h-48 object-cover">
                    <input accept="image/*" class="w-full" type="file" @change="handleSelectedImage" />
                </div>
                <div class="mt-6">
                    <Button
        ...
        >
            ...
            <form class="mt-2" @submit.prevent="updateAgency">
                ...
                <div class="mt-6">
                    <img :src="imageUrl" v-show="imageUrl" class="w-48 h-48">
                    <input
                        accept="image/*"
                        class="w-full"
                        type="file"
