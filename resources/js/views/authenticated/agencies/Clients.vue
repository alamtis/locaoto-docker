...
<template>
    ...
    >
        ...
        <form class="mt-2" @submit.prevent="submit">
            <div class="md:mt-6 md:flex md:justify-between">
                <span class="p-float-label mt-6 md:mr-4 md:mt-0 md:flex-1">
                    <InputText
                ...
                <span class="p-float-label mt-6 md:mt-0 md:flex-1">
                    <InputText
            ...
            <div class="mt-6">
                <span class="p-float-label">
                    ...
                    <label for="email">
                        Adresse email
                        <span class="text-sm text-red-400"> (Optionnel) </span>
                    </label>
                </span>
            </div>
            <div class="mt-6">
    ...
    >
        ...
        <form @submit.prevent="update">
            <div class="md:mt-6 md:flex md:justify-between">
                ...
                <span
                    class="p-float-label p-float-label mt-6 md:mt-0 md:flex-1"
                >
                    <InputText
                        id="elastName"
            ...
            <div class="md:mt-6 md:flex md:justify-between">
                ...
                <span class="p-float-label mt-6 md:mt-0 md:flex-1">
                    <Calendar
                        ...
                        dateFormat="dd/mm/yy"
                    />
                    <label for="eidentity">Date d'obtention de permis</label>
                </span>
            </div>
            <div class="mt-6">
                <span class="p-float-label">
    ...
    <div class="grid grid-cols-1">
        ...
        >
            ...
            <template #loading>
                Chargement des clients, veuillez patienter.
            </template>
            <Column :expander="true" headerStyle="width: 3rem" />
            <Column bodyClass="capitalize" field="name" header="Nom complet" />
            <Column
